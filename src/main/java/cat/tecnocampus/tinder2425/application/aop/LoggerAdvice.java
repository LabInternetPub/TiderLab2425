package cat.tecnocampus.tinder2425.application.aop;
...
public class LoggerAdvice {
    ...
    // any parameter
    @Pointcut("execution (* cat.tecnocampus.tinder2425.application.TinderService.*Profile*(..))")
    ...
    @Pointcut("within(cat.tecnocampus.tinder2425.api..*) && args(java.security.Principal)")
    ...
    @Pointcut("execution(java.util.List<cat.tecnocampus.tinder2425.domain.Like> * (..))")
    ...
    @Pointcut("execution(* cat.tecnocampus.tinder2425.application.TinderService.getCandidates*(..)) && args(user)")
